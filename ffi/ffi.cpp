...
static inline lean_obj_res datatypeConstructor_box(DatatypeConstructor* dtc)
{
...
static inline lean_obj_res datatype_box(Datatype* dt)
{
...
{
  return datatypeConstructor_box(
      new DatatypeConstructor((*datatype_unbox(dt))[lean_usize_of_nat(idx)]));
}

extern "C" lean_obj_res datatype_getConstructor(lean_obj_arg dt,
                                                lean_obj_arg name)
{
  CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
  return except_ok(
      ...
      datatypeConstructor_box(new DatatypeConstructor(
          datatype_unbox(dt)->getConstructor(lean_string_cstr(name)))));
  CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
}

extern "C" lean_obj_res datatype_toString(lean_obj_arg dt)
{
  return lean_mk_string(datatype_unbox(dt)->toString().c_str());
}
                                        ...
                                        lean_obj_arg replacements)
{
  ...
  static inline lean_obj_res proof_box(Proof * p)
  {
    ...
    {
      g_proof_class =
          lean_register_external_class(proof_finalize, proof_foreach);
    }
  ...
  static inline lean_obj_res tm_box(TermManager * tm)
  {
    ...
    {
      g_termManager_class = lean_register_external_class(termManager_finalize,
                                                         termManager_foreach);
    }
  ...
  extern "C" lean_obj_arg termManager_mkArraySort(
      lean_obj_arg tm, lean_obj_arg idx, lean_obj_arg elm)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    return except_ok(lean_box(0),
  ...
  extern "C" lean_obj_arg termManager_mkFunctionSort(
      lean_obj_arg tm, lean_obj_arg sorts, lean_obj_arg codomain)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    std::vector<Sort> cvc5Sorts;
    for (size_t i = 0, n = lean_array_size(sorts); i < n; ++i)
                                                     ...
                                                     lean_obj_arg sort)
  {
    ...
    return except_ok(lean_box(0),
                     sort_box(new Sort(
                         mut_tm_unbox(tm)->mkNullableSort(*sort_unbox(sort)))));
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
  }
  ...
  extern "C" lean_obj_arg termManager_mkTuple(lean_obj_arg tm,
                                              lean_obj_arg terms)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    std::vector<Term> ts;
                                                     ...
                                                     lean_obj_arg sort)
  {
    ...
    return except_ok(lean_box(0),
                     term_box(new Term(
                         mut_tm_unbox(tm)->mkNullableNull(*sort_unbox(sort)))));
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
  }

  extern "C" lean_obj_arg termManager_mkVar(
      lean_obj_arg tm, lean_obj_arg sort, lean_obj_arg val)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    return except_ok(lean_box(0),
                     term_box(new Term(mut_tm_unbox(tm)->mkVar(
                         *sort_unbox(sort), lean_string_cstr(val)))));
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
  }
                                                     ...
                                                     lean_obj_arg term)
  {
    ...
    return except_ok(lean_box(0),
                     term_box(new Term(
                         mut_tm_unbox(tm)->mkNullableSome(*term_unbox(term)))));
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
  }
                                                       ...
                                                       lean_obj_arg term)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    return except_ok(lean_box(0),
                     term_box(new Term(mut_tm_unbox(tm)->mkNullableIsSome(
                         *term_unbox(term)))));
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
  }

  extern "C" lean_obj_arg termManager_mkNullableIsNull(lean_obj_arg tm,
                                                       lean_obj_arg term)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    return except_ok(lean_box(0),
                     term_box(new Term(mut_tm_unbox(tm)->mkNullableIsNull(
                         *term_unbox(term)))));
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_END;
  }

  extern "C" lean_obj_arg termManager_mkNullableLift(
      lean_obj_arg tm, uint16_t kind, lean_obj_arg args)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
  ...
  extern "C" lean_obj_res termManager_mkString(
      lean_obj_arg tm, lean_obj_arg s, uint8_t useEscSequences)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
  ...
  extern "C" lean_obj_res termManager_mkTerm(
      lean_obj_arg tm, uint16_t kind, lean_obj_arg children)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    Kind k = static_cast<Kind>(static_cast<int32_t>(kind) - 2);
    std::vector<Term> cs;
    ...
    {
      cs.push_back(*term_unbox(lean_array_get(
          term_box(new Term()), children, lean_usize_to_nat(i))));
    }
    return except_ok(lean_box(0),
  ...
  extern "C" lean_obj_res termManager_mkTermOfOp(
      lean_obj_arg tm, lean_obj_arg op, lean_obj_arg children)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    std::vector<Term> cs;
    for (size_t i = 0, n = lean_array_size(children); i < n; ++i)
  ...
  extern "C" lean_obj_res termManager_mkConst(
      lean_obj_arg tm, lean_obj_arg sort, lean_obj_arg symbol)
  {
    return term_box(new Term(mut_tm_unbox(tm)->mkConst(
  ...
  extern "C" lean_obj_res termManager_mkOpOfString(
      lean_obj_arg tm, uint16_t kind, lean_obj_arg arg)
  {
    CVC5_LEAN_API_TRY_CATCH_EXCEPT_BEGIN;
    Kind k = static_cast<Kind>(static_cast<int32_t>(kind) - 2);
    return except_ok(
  ...
  extern "C" lean_obj_res solver_setLogic(
      lean_obj_arg inst, lean_object * logic, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
  ...
  extern "C" lean_obj_res solver_assertFormula(
      lean_obj_arg inst, lean_object * term, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
  ...
  extern "C" lean_obj_res solver_checkSat(lean_obj_arg inst,
                                          lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
  ...
  extern "C" lean_obj_res solver_checkSatAssuming(
      lean_obj_arg inst, lean_obj_arg assumptions, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
  ...
  extern "C" lean_obj_res solver_getProof(lean_obj_arg inst,
                                          lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
  ...
  extern "C" lean_obj_res solver_getValue(
      lean_obj_arg inst, lean_obj_arg term, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
    return solver_val(
        lean_box(0),
  ...
  extern "C" lean_obj_res solver_getValues(
      lean_obj_arg inst, lean_obj_arg terms, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
    std::vector<Term> ts;
    for (size_t i = 0, n = lean_array_size(terms); i < n; ++i)
  ...
  extern "C" lean_obj_res solver_proofToString(
      lean_obj_arg inst, lean_obj_arg proof, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
    return solver_val(
        lean_box(0),
  ...
  extern "C" lean_obj_res solver_parseCommands(
      lean_obj_arg inst, lean_obj_arg query, lean_obj_arg solver)
  {
    CVC5_LEAN_API_TRY_CATCH_SOLVER_BEGIN;
